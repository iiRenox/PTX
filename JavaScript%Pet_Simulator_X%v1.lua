...
Section:NewSlider(
    "WalkSpeed",
    "Slide to change WalkSpeed",
    250,
    16,
    function(s) -- 250 (MaxValue) | 16 (MinValue)
        game.Players.LocalPlayer.Character.Humanoid.WalkSpeed = s
    end
)
Section:NewSlider(
    "JumpPower",
    "Slide to change JumpPower",
    250,
    50,
    function(s) -- 250 (MaxValue) | 50 (MinValue)
        game.Players.LocalPlayer.Character.Humanoid.JumpPower = s
    end
)
Section:NewButton(
    "Noclip E",
    "Press E to Enable Noclip",
    function()
